                ...
                <div class="col-md-12 col-lg-12 col-sm-12">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:Button ID="button" runat="server" Text="Add New" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#largeModal" OnClick="button_Click" />
                    ...
                    <table class="table table-bordered table table-striped table table-hover" id="dataTable" width="100%" cellspacing="0">
                        <asp:Repeater ID="rpt_data" runat="server">
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td>
                                        <asp:Label ID="RoleCo" runat="server" Text='<%# Eval("User_Code") %>'></asp:Label>
                                    </td>
                                    <td align="center">
                                        <asp:Label ID="RoleNa" runat="server" Text='<%# Eval("User_ID") %>'></asp:Label>
                                    </td>
